...
class Snakeling:
    ...
    def gen_image(self):
        ...
        number = HitsplatNumber(self.val).image.convert('RGBA')
...
if __name__ == '__main__':
    scale(FullHitsplat(4, Background('normal')).image, 2).show()
    scale(FullHitsplat(5, Background('venom')).image, 2).show()
    Snakeling(3).image.show()
